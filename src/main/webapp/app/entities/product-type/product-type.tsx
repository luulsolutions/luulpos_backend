...
import { getSearchEntities, getEntities } from './product-type.reducer';
...
export class ProductType extends React.Component<IProductTypeProps, IProductTypeState> {
  ...
  render() {
    const { productTypeList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="product-type-heading">
          <Translate contentKey="luulposApp.productType.home.title">Product Types</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="luulposApp.productType.home.createLabel">Create new Product Type</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('luulposApp.productType.home.search')}
                  />
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('productType')}>
                  <Translate contentKey="luulposApp.productType.productType">Product Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('productTypeDescription')}>
                  <Translate contentKey="luulposApp.productType.productTypeDescription">Product Type Description</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="luulposApp.productType.shop">Shop</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {productTypeList.map((productType, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{productType.shopShopName ? <Link to={`shop/${productType.shopId}`}>{productType.shopShopName}</Link> : ''}</td>
