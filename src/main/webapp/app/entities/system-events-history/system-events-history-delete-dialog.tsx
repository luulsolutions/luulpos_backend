...
export class SystemEventsHistoryDeleteDialog extends React.Component<ISystemEventsHistoryDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.systemEventsHistoryEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="luulposApp.systemEventsHistory.delete.question">
          <Translate contentKey="luulposApp.systemEventsHistory.delete.question" interpolate={{ id: systemEventsHistoryEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-systemEventsHistory" color="danger" onClick={this.confirmDelete}>
