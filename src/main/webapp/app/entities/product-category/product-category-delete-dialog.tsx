  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="luulposApp.productCategory.delete.question">
          <Translate contentKey="luulposApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
