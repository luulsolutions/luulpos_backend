    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .body(StringBody("""{
                ...
                , "productDescription":"SAMPLE_TEXT"
                , "price":"0"
                , "quantity":"0"
                , "productImageFull":null
                , "productImageFullUrl":"SAMPLE_TEXT"
                , "productImageThumb":null
                , "productImageThumbUrl":"SAMPLE_TEXT"
                , "dateCreated":"2020-01-01T00:00:00.000Z"
                , "barcode":"SAMPLE_TEXT"
                , "serialCode":"SAMPLE_TEXT"
                , "priorityPosition":"0"
                , "active":null
                , "isVariantProduct":null
                }""")).asJSON
            .check(status.is(201))
